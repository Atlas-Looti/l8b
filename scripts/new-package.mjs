...
if (
	...
	console.log(
		"Usage: bun run new <package-name> [workspace]",
	);
	console.log(
		"  workspace options: 'packages' (default) or 'lootiscripts'",
	);
	process.exit(
		1,
	);
...
if (
	...
	console.error(
		`❌ Error: Package "${packageName}" already exists!`,
	);
	process.exit(
		1,
	);
...
console.log(
	`📦 Creating new package: @l8b/${packageName}`,
);
