...
export const screenMessages: Record<
	string,
	MessageTemplate
> = {
	[APIErrorCode.E7001]:
	...
	[APIErrorCode.E7002]:
		{
			...
			description:
				"Canvas dimensions are invalid (zero or negative)",
			suggestions:
				[
	...
	[APIErrorCode.E7003]:
		{
			...
			message:
				(
					...
					`Invalid color format: ${args.color}`,
			description:
				"The color value provided is not in a valid format",
			suggestions:
				[
	...
	[APIErrorCode.E7004]:
		{
			...
			message:
				(
					...
					`Sprite not found: '${args.spriteName}'`,
			description:
				"The requested sprite does not exist in the sprite collection",
			suggestions:
				[
	...
	[APIErrorCode.E7005]:
		{
			...
			message:
				(
					...
					`Sprite '${args.spriteName}' is not ready`,
			description:
				"The sprite exists but has not finished loading",
			suggestions:
				[
	...
	[APIErrorCode.E7006]:
		{
			...
			message:
				(
					...
					`Invalid font: '${args.font}'`,
			description:
				"The font name is invalid or not available",
			suggestions:
				[
	...
	[APIErrorCode.E7007]:
		{
			...
			message:
				(
					...
					`Invalid blend mode: '${args.blendMode}'`,
			description:
