...
export const paletteMessages: Record<
	string,
	MessageTemplate
> = {
	[APIErrorCode.E7071]:
		{
			...
			message:
				(
					...
					`Palette not found: '${args.paletteName}'`,
			description:
	...
	[APIErrorCode.E7072]:
		{
			...
			message:
				(
					...
					`Invalid palette format: ${args.format || "unknown"}`,
			description:
				"The palette format is not supported",
			suggestions:
				[
	...
	[APIErrorCode.E7073]:
		{
			...
			description:
				"The color index is out of palette range",
			suggestions:
				[
	...
	[APIErrorCode.E7074]:
		{
			...
			description:
				"The palette could not be loaded",
			suggestions:
				[
