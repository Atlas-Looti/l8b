...
export const mapMessages: Record<
	string,
	MessageTemplate
> = {
	[APIErrorCode.E7031]:
		{
			...
			message:
				"Map canvas context failed",
			description:
				"Could not get 2D context for map rendering canvas",
			suggestions:
				[
	...
	[APIErrorCode.E7032]:
		{
			...
			description:
				"Tile coordinates are out of map bounds",
			suggestions:
				[
	...
	[APIErrorCode.E7033]:
		{
			...
			message:
				(
					...
					`Tile sprite not found: '${args.spriteName}'`,
			description:
				"The sprite for the tile does not exist",
			suggestions:
				[
