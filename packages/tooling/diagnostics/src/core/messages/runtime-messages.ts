...
export const runtimeMessages: Record<
	string,
	MessageTemplate
> = {
	[RuntimeErrorCode.E2001]:
		{
			...
			message:
				(
					...
					`Undefined variable '${args.variableName}'`,
			description:
	...
	[RuntimeErrorCode.E2002]:
		{
			...
			description:
				"An operation was performed with incompatible types",
			suggestions:
				[
	...
	[RuntimeErrorCode.E2004]:
		{
			...
			message:
				(
					...
					`Function '${args.functionName}' not found`,
			description:
