		...
		ITokenizer
{
	...
	constructor(
		...
		this.chars[
			"{"
		] = 22; // TYPE_OPEN_CURLY_BRACE (not defined in Token)
		this.chars[
			"}"
		] = 23; // TYPE_CLOSED_CURLY_BRACE (not defined in Token)
		this.chars[
			"^"
		] =
			Token.TYPE_POWER;
