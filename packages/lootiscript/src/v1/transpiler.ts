...
export class Transpiler {
	...
	constructor() {
		this.opcodeHandlers =
			{
				LOAD_VALUE:
					this.LOAD_VALUE.bind(
						this,
					),
				LOAD_LOCAL:
					this.LOAD_LOCAL.bind(
						this,
					),
				LOAD_LOCAL_OBJECT:
					this.LOAD_LOCAL_OBJECT.bind(
						this,
					),
				STORE_LOCAL:
					this.STORE_LOCAL.bind(
						this,
					),
				POP: this.POP.bind(
					this,
				...
				CREATE_PROPERTY:
					this.CREATE_PROPERTY.bind(
						this,
					),
				LOAD_PROPERTY:
					this.LOAD_PROPERTY.bind(
						this,
					),
				LOAD_PROPERTY_ATOP:
					this.LOAD_PROPERTY_ATOP.bind(
						this,
					),
				NEW_OBJECT:
					this.NEW_OBJECT.bind(
						this,
					),
				NEW_ARRAY:
					this.NEW_ARRAY.bind(
				...
				MAKE_OBJECT:
					this.MAKE_OBJECT.bind(
						this,
					),
				STORE_VARIABLE:
					this.STORE_VARIABLE.bind(
						this,
					),
				STORE_PROPERTY:
					this.STORE_PROPERTY.bind(
						this,
					),
			};
	}
