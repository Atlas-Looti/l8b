...
export class SceneManager {
	...
	private activeSceneName:
		...
		| null =
		null;
	private activeScene: SceneDefinition | null =
		null;
	...
	registerScene(
		...
		if (
			!this.validateSceneRegistration(
				name,
				definition,
			)
		) {
	...
	setActiveScene(
		...
		if (
			...
			this.handleSameSceneActivation(
				newScene,
				name,
				params,
			);
	 ...
	 */
	private initializeSceneIfNeeded(
		_name: string,
		scene: SceneDefinition,
	): void {
		if (
