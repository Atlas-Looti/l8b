...
export class BaseScreen {
	...
	// Transformations
	protected translation_x =
		0;
	protected translation_y =
		0;
	protected rotation =
		0;
	protected scale_x =
	...
	protected scale_y =
		1;
	protected screen_transform =
		false;

	// Object transformations
	protected object_rotation =
		0;
	protected object_scale_x =
		1;
	protected object_scale_y =
		1;
	protected anchor_x =
		0;
	protected anchor_y =
	...
	protected blending: Record<
		string,
		string
	> = {};
	protected font_load_requested: Record<
		string,
		boolean
	> = {};
	protected font_loaded: Record<
		string,
		boolean
	> = {};

	// Interface cache
	protected interfaceCache: ScreenInterface | null =
		null;
