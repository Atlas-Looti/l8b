		...
		for (
			...
			if (
				...
				this.status.LEFT_STICK_AMOUNT =
					padState.LEFT_STICK_AMOUNT;
				this.status.LEFT_STICK_ANGLE =
					padState.LEFT_STICK_ANGLE;
			}
			if (
				(padState.RIGHT_STICK_AMOUNT ??
					0) >
				(this
					.status
					.RIGHT_STICK_AMOUNT ??
				...
				this.status.RIGHT_STICK_AMOUNT =
					padState.RIGHT_STICK_AMOUNT;
				this.status.RIGHT_STICK_ANGLE =
					padState.RIGHT_STICK_ANGLE;
			}
		}
	}
