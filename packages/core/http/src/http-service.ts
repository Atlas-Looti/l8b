	...
	private createResponse(
		...
		return {
			...
			ensureOk: () => {
				...
				return service.createResponse(response, responseText, requestUrl);
			},
		};
	}
	...
	getInterface(): HttpAPI {
		...
		return {
			...
			get: async (
				...
				return service.makeRequest(url, { ...options, method: "GET" });
			},
			...
			delete: async (
				...
				return service.makeRequest(url, { ...options, method: "DELETE" });
			},
		};
	}
