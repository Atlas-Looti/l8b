...
if (
	...
	throw new Error(
		"Canvas element with id 'game' not found",
	);
...
// Start the game
console.log(
	"Starting L8B Runtime with Scene Routing...",
);
try {
	await runtime.start();
	console.log(
...
(
	...
	runtime;
console.log(
	"Runtime available as window.runtime",
);
console.log(
	"Try: runtime.sceneManager.router.push('/battle')",
);
