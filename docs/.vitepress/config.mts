		...
		sidebar: [
			...
			},
			{
				...
				items: [
					{
						text: "Screen",
						link: "/fundamentals/api-reference-screen",
					},
					{
						text: "Inputs",
						link: "/fundamentals/api-reference-inputs",
					},
					{
						text: "Audio",
						link: "/fundamentals/api-reference-audio",
					},
					{
						text: "Assets",
						link: "/fundamentals/api-reference-assets",
					},
					{
						text: "System",
						link: "/fundamentals/api-reference-system",
					},
					{
						text: "Storage",
						link: "/fundamentals/api-reference-storage",
					},
					{
						text: "Palette",
						link: "/fundamentals/api-reference-palette",
					},
					{
						text: "Scene",
						link: "/fundamentals/api-reference-scene",
					},
					{
						text: "Router",
						link: "/fundamentals/api-reference-router",
					},
					{
						text: "Sprites",
						link: "/fundamentals/api-reference-sprites",
					},
					{
						text: "Maps",
						link: "/fundamentals/api-reference-maps",
					},
					{
						text: "Images",
						link: "/fundamentals/api-reference-images",
					},
					{
					...
					{
						text: "Player API",
						link: "/fundamentals/api-reference-player",
					},
					{
						text: "Wallet API",
						link: "/fundamentals/api-reference-wallet",
					},
					{
						text: "EVM API",
						link: "/fundamentals/api-reference-evm",
					},
					{
						text: "Actions API",
						link: "/fundamentals/api-reference-actions",
					},
					{
						text: "HTTP API",
						link: "/fundamentals/api-reference-http",
					},
				],
			},
			{
